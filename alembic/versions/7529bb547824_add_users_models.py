...
Revision ID: 7529bb547824
Revises: 
Create Date: 2025-05-14 15:53:03.363334
...
def upgrade():
    ...
    sa.Column('photo', advanced_alchemy.types.file_object.data_type.StoredObject(backend="local"), nullable=True),
    ...
    sa.Column('created_at', advanced_alchemy.types.datetime.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', advanced_alchemy.types.datetime.DateTimeUTC(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_agent_contacts_user_id_users'), ondelete='CASCADE'),
